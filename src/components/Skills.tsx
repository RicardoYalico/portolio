...
const skillsLogos = {
  ...
  ['Back' as string]: [
    {
      name: 'SpringBoot',
      image: '/logos/springboot-logo.png',
    },
    {
      name: '.NET',
      image: '/logos/net-logo.svg',
    },
    {
      name: 'NodeJS',
    ...
    {
      name: 'SqlServer',
      image: '/logos/sqlserver-logo.png',
    },
    {
      name: 'PostgresSql',
  ...
  ['Tools' as string]: [
    ...
    { name: 'PowerBi', 
      image: '/logos/powerbi-logo.png' 
    },
    {
      name: 'Excel',
      image: '/logos/excel-logo.jpg',
    },
    {
      name: 'EsLint',
...
const skillsTitles = {
  ['Lenguajes' as string]: 'Programming Languages',
